...
const RectRegister = () => {
    ...
    const{name,email,company,mobile} = recruiter
    ...
    {
      e.preventDefault();
      await axios.post("http://localhost:7777/addRegister",recruiter)
      setDis2('blur-lg')
      setDis1('visible')
    }
    const disp = () =>
  ...
  return (
    <>
    <div className={`bg-gray-200 min-h-screen min-w-screen flex flex-row justify-center ${dis2}`}>
    <div className='bg-white w-2/6 mb-20 mt-20'>
        ...
        <label className='ml-10'>Company Name <span className='text-red-600'>*</span></label><br/>
        <input type='text'placeholder='Enter Your Company Name' name="company" value={company} onChange={(e)=>onInputChange(e)} className='border-2 ml-10 mt-3 w-96 h-12 pl-4 mb-5' required/><br/>
